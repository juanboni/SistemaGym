...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="javascript:void(0)">Sistema de Encuestas Gimnasio</a>
	...
	<?php
		...
		$resultadocount = $resultados->fetch_assoc();

				/*TITULO*/
		echo "<h3 >" . $row2['titulo'] . "</h3>";
		echo "<h3>valor : " . $resultadocount['valor'] . "</h3>";
		echo "<h3>Numero de personas : " . $resultadocount['count'] . "</h3>";
